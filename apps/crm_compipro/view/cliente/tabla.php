...
?>
<div class="bg-white w-full rounded-lg shadow-md px-1">
<div class="min-h-[50vh] ">
  <table class="tabla-mini w-full divide-y divide-gray-200 text-xs rounded-lg overflow-hidden ml-12 ">

<thead class="sticky top-0 z-10 bg-gray-800 text-white ">
    <tr>
      <?php foreach ($encabezados as $index => $texto): ?>
        <th class="p-3 text-left <?= $index === 0 ? 'rounded-tl-lg' : '' ?> <?= $index === count($encabezados) - 1 ? 'rounded-tr-lg' : '' ?>">
...
<div id="modalEstado" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
