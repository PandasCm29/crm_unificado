export const paginacion = {
    ...
    renderPaginationControls() {
        ...
        `;
        //BONTON ANTERIOR (<)
        html += createPageBtn('‹', this.currentPage - 1, false, this.currentPage === 1);
        const pages = [];
        ...
        for (const p of pages) {
            if (p === '...') {
                ...
                html += createPageBtn(p, p, this.currentPage === p);
            }
        }
        //BOTON SIGUIENTE (>)
        html += createPageBtn('›', this.currentPage + 1, false, this.currentPage === this.totalPages);
