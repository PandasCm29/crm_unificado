...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById('estado').addEventListener('change', (e) => {
      document.getElementById('estado-label').textContent = e.target.checked ? 'Activo' : 'Inactivo';
  });  
  ...
  btnSearch?.addEventListener("click", cargarUsuarios);
  let reloaded = true;
  ...
  paginacion.renderFunction = cargarUsuarios;
